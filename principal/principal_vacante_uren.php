...
<body style="background-color: #3fa435;">
    ...
    <a class="active" href="principal_vacante_uren.php">Vacante Uren</a>
    ...
    <h3 style='font-size:50px;color:white' align='center'>Vul de formulier voor de vacante uren:</h3>
    ...
    $('#insert_form').on('submit' , function(event){
        ...
        if(error == '')  
        {
            $.ajax({
                ...
                url:"principal_insert_vacante.php",
