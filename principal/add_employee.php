...
<div class="topnav">
  ...
  <a class="active" href="add_employee.php">Werknemer Aanmaken</a>
  ...
  <a class="logout" href="../login/logout.php">⠀<i class="fa fa-sign-out"></i>⠀Logout</a>
    ...
    <div class="container">
        <h3 style="font-size:50px;color:white" align="center">Account van een werknemer aanmaken: </h3>
        <br>

        
        <div style="max-width: 700px; margin: 0 auto; margin-top:65px"  class="card">
